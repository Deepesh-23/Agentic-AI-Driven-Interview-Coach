...
│   │   │   ├── __init__.py
│   │   │   ├── orchestrator_agent.py      NLP intent routing
│   │   │   ├── interview_agent.py         Interview conversation logic
│   │   │   ├── debate_agent.py            Debate conversation logic
│   │   │   ├── intro_agent.py             Self-intro conversation logic
│   │   │   └── evaluation_orchestrator.py LangGraph evaluation engine
│   │   │
│   │   ├── api/                 REST API route handlers
│   │   │   ├── __init__.py
│   │   │   ├── routes_auth.py           User registration and login
│   │   │   ├── routes_interview.py      Interview mode endpoints
│   │   │   ├── routes_debate.py         Debate mode endpoints
│   │   │   ├── routes_intro.py          Introduction mode endpoints
│   │   │   ├── routes_dashboard.py      Analytics and history
│   │   │   └── routes_orchestrator.py   Intent routing endpoint
│   │   │
│   │   └── services/            Business logic and analysis
│   │       ├── __init__.py
│   │       ├── audio_service.py              Audio transcription
│   │       ├── content_analysis_service.py   LLM content grading
│   │       ├── emotion_service.py            Tone and emotion detection
│   │       ├── evaluation_service.py         Score aggregation
│   │       └── nlp_service.py                Text analysis utilities
│   │
│   ├── data/
│   │   └── questions/                    Interview questions database (CSV files)
│   │
...
│       │   ├── authFetch.js     HTTP client with JWT auth
│       │   └── config.js        API endpoint configuration
│       │
│       ├── components/          Reusable UI components
│       │   ├── AudioRecorder.jsx          WebAudio recording component
│       │   ├── EvaluationReport.jsx       Score display component
│       │   ├── EvaluationReport.module.css Component styling
│       │   └── LivePostureTracker.jsx     MediaPipe visualization
│       │
│       ├── pages/               Page components
│       │   ├── LoginPage.jsx             User authentication page
│       │   ├── Dashboard.jsx             Main dashboard
│       │   ├── Dashboard.module.css
│       │   ├── InterviewMode.jsx         Interview session page
│       │   ├── DebateMode.jsx            Debate session page
│       │   ├── SelfIntroductionMode.jsx  Introduction session page
│       │   └── SessionMode.module.css    Session page styling
│       │
│       ├── context/
