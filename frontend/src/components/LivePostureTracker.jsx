...
const LivePostureTracker = ({ onStatsUpdate, isRecording, onVideoReady, onMultiplePeopleWarning, onMultiplePeopleEnd }) => {
    ...
    const startCameraSystem = () => {
        ...
        pose.onResults((results) => {
            ...
            // Override warning if phone was detected recently (within last 3 seconds)
            if (now - lastPenaltyTimeRef.current.phone < 3000) {
                currentWarning = "⚠️ Mobile phone detected in frame!";
            }
